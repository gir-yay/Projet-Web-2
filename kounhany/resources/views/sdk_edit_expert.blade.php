...
<body>
    ...
    <form action="{{route("expert.sdk_stockupdatex",$expert)}}" method="POST" enctype="multipart/form-data">
        @method('PUT')
        @csrf
        ...
        @enderror
        <input type="text" name="nom" value="{{old("nom",$expert->nom)}}">
        ...
        <span class="error-message" style="color: red; font-weight: bold; font-style: italic;">{{ $message }} </span>
        @enderror
        <input type="text" name="metier" value="{{old("metier",$expert->metier)}}">

        <label for="bio">Bio</label>
        @error('bio')
        <span class="error-message" style="color: red; font-weight: bold; font-style: italic;">{{ $message }} </span>
        @enderror
        <input type="text" name="bio" value="{{old("bio",$expert->bio)}}">
