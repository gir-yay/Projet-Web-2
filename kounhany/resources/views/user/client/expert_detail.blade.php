...
<body>
    ...
    <div class="container">
        ...
        <div class="detail">
            ...
            <div class="content">
                <h1 class="name"> {{ $expert->nom }} {{ $expert->prenom }} <div class="price ville">
                        {{ $serviceExpert->nbr_annee_d_exp }} d'expérience</div>
                </h1>
                <div class="price"><i class="fas fa-dollar-sign"></i>{{ $serviceExpert->prix_par_duree }} / jour</div>
                <div class="price ville" style="font-size=200;"> <i class="fa fa-map-marker-alt"></i>
                    {{ $serviceExpert->ville }}</div>
                <div class="price ville"><i class="fa-solid fa-calendar-days"></i> {{ $serviceExpert->disponibilite }}
                </div>
                        ...
                        @foreach ($comments as $comment)
                            <div class="box-area">
                                ...
                                <div class="rating">
                                    @for ($i = 1; $i <= 5; $i++)
                                        @if ($i <= $comment->note)
                                            <i class="fa fa-star" style="color: #583A28;"></i>
                                            <!--  les étoiles remplies -->
                                        @else
